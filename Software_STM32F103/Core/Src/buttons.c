...
#define UPDATE_TIME_LOW_TO_HIGH_DEFAULT 3		//TIM1 has 100Hz frequency -> e.g. 3 updates are equal to ~30ms
#define UPDATE_TIME_HIGH_TO_LOW_DEFAULT 3		//TIM1 has 100Hz frequency -> e.g. 3 updates are equal to ~30ms
...
void update_button_statuses(void);
