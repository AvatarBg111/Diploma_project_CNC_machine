...
#define USER_LED_A_Pin GPIO_PIN_4
#define USER_LED_A_GPIO_Port GPIOE
#define USER_LED_B_Pin GPIO_PIN_5
#define USER_LED_B_GPIO_Port GPIOE
#define USER_LED_C_Pin GPIO_PIN_6
#define USER_LED_C_GPIO_Port GPIOE
#define USER_LED_D_Pin GPIO_PIN_13
#define USER_LED_D_GPIO_Port GPIOC
...
#define USER_BUT_F_Pin GPIO_PIN_6
#define USER_BUT_F_GPIO_Port GPIOB
#define USER_BUT_E_Pin GPIO_PIN_7
#define USER_BUT_E_GPIO_Port GPIOB
#define USER_BUT_D_Pin GPIO_PIN_8
#define USER_BUT_D_GPIO_Port GPIOB
#define USER_BUT_C_Pin GPIO_PIN_9
#define USER_BUT_C_GPIO_Port GPIOB
#define USER_BUT_B_Pin GPIO_PIN_0
#define USER_BUT_B_GPIO_Port GPIOE
#define USER_BUT_A_Pin GPIO_PIN_1
