...
mpg_settings_t mpg_settings = {
	.x_axis_multiplicity = {X_AXIS_MULTIPLICITY_DEFAULT_PRECISE, X_AXIS_MULTIPLICITY_DEFAULT_NORMAL, X_AXIS_MULTIPLICITY_DEFAULT_COARSE},
	.yz_axis_multiplicity = {YZ_AXIS_MULTIPLICITY_DEFAULT_PRECISE, YZ_AXIS_MULTIPLICITY_DEFAULT_NORMAL, YZ_AXIS_MULTIPLICITY_DEFAULT_COARSE},
	.jog_speeds = {JOG_SPEED_DEFAULT_SLOW, JOG_SPEED_DEFAULT_NORMAL, JOG_SPEED_DEFAULT_FAST},
...
void process_pendant_data_to_action(void){
	...
	action.jog_mode = pendant_control.jog_mode;	//current_data.jog_mode;
